...
#       sudo virt-filesystems -a ~/.vagrant.d/boxes/fedora-44-uefi-amd64/0/libvirt/box.img
#       sudo guestmount -a ~/.vagrant.d/boxes/fedora-44-uefi-amd64/0/libvirt/box.img -m /dev/sda2 --pid-file guestmount.pid --ro /mnt
