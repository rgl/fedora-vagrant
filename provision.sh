...
#       sudo virt-filesystems -a ~/.vagrant.d/boxes/fedora-36-amd64/0/libvirt/box.img
#       sudo guestmount -a ~/.vagrant.d/boxes/fedora-36-amd64/0/libvirt/box.img -m /dev/sda1 --pid-file guestmount.pid --ro /mnt
